...
migration_data = Dict( # 1 <-> 2
    ...
    ("Male", "WR") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ...
    ("Female", "WW") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ("Female", "WR") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ...
    ("Male", "WR") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ...
    ("Female", "WW") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Female", "WR") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ...
    ("Male", "WR") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ...
    ("Female", "WW") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Female", "WR") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ...
    ("Male", "WR") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ...
    ("Female", "WW") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Female", "WR") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ...
    ("Male", "WR") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ...
    ("Female", "WW") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Female", "WR") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
...
# SpatialReduction:
sol_spatial_mip = solve_decision_model_test(prob_mip,
    SpatialReduction;
    wildtype=wild_gene,
    node_to_suppress = 4,
    percent_to_suppress=.98,
