...
migration_data = Dict( # 1 <-> 2
    ("Male", "HH") => Dict((:Node1, :Node2) => move_rate,
                           (:Node2, :Node1) => move_rate),
    ("Male", "Hh") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ("Male", "HR") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ("Male", "hh") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ("Male", "hR") => Dict((:Node1, :Node2) => move_rate,
                             (:Node2, :Node1) => move_rate),
    ("Male", "RR") => Dict((:Node1, :Node2) => move_rate,
                             (:Node2, :Node1) => move_rate),

    ("Female", "HH") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ("Female", "Hh") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ("Female", "HR") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ("Female", "hh") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ("Female", "hR") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
    ("Female", "RR") => Dict((:Node1, :Node2) => move_rate,
                            (:Node2, :Node1) => move_rate),
                            # 1 <-> 3
    ("Male", "HH") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Male", "Hh") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Male", "HR") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Male", "hh") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Male", "hR") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Male", "RR") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),

    ("Female", "HH") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Female", "Hh") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Female", "HR") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Female", "hh") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Female", "hR") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
    ("Female", "RR") => Dict((:Node1, :Node3) => move_rate,
                            (:Node3, :Node1) => move_rate),
                            # 3 <-> 2
    ("Male", "HH") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Male", "Hh") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Male", "HR") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Male", "hh") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Male", "hR") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Male", "RR") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),

    ("Female", "HH") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Female", "Hh") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Female", "HR") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Female", "hh") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Female", "hR") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
    ("Female", "RR") => Dict((:Node2, :Node3) => move_rate,
                            (:Node3, :Node2) => move_rate),
                            # 3 <-> 4
    ("Male", "HH") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Male", "Hh") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Male", "HR") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Male", "hh") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Male", "hR") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Male", "RR") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),

    ("Female", "HH") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Female", "Hh") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Female", "HR") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Female", "hh") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Female", "hR") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
    ("Female", "RR") => Dict((:Node4, :Node3) => move_rate,
                            (:Node3, :Node4) => move_rate),
                            # 4 <-> 5
    ("Male", "HH") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Male", "Hh") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Male", "HR") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Male", "hh") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Male", "hR") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Male", "RR") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),

    ("Female", "HH") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Female", "Hh") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Female", "HR") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Female", "hh") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Female", "hR") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
    ("Female", "RR") => Dict((:Node4, :Node5) => move_rate,
                            (:Node5, :Node4) => move_rate),
);
...
sol_targperc = solve_decision_model(prob,
    TargetPercentageByDate;
    wildtype=wild_gene, percent_suppression=.20,
    target_timestep=200) 

res_targperc = GeneDrive.format_decision_model_results(sol_targperc)

# SpatialReduction:
sol_spatial = solve_decision_model(prob,
    SpatialReduction;
    wildtype=wild_gene,
    node_to_suppress = 4,
